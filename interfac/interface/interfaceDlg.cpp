...
BEGIN_MESSAGE_MAP(CinterfaceDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_LOGIN_BUTTON, &CinterfaceDlg::OnBnClickedLoginButton)
	ON_BN_CLICKED(IDC_REGIST_BUTTON, &CinterfaceDlg::OnBnClickedRegistButton)
END_MESSAGE_MAP()
...
void CinterfaceDlg::OnBnClickedLoginButton()
{
	INT_PTR nRes;
	CHomeDlg homeDlg;
...
void CinterfaceDlg::OnBnClickedRegistButton()
{
	INT_PTR nRes;
